...
jobs.forEach((item) => {
  ...
  const listPostText=document.createElement("p")
  listPostText.classList.add("list__post-text")
  ...
  itemListPost.appendChild(listPostText)
  ...
  listPostText.textContent = `${item.role} ${item.level} ${item.languages}`;
